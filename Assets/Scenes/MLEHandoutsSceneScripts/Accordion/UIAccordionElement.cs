...
namespace UnityEngine.UI
{
	...
	public class UIAccordionElement : Toggle
	{
		...
		protected override void Awake()
		{
			...
			//Debug.Log("UIAccordionElement_Awake");
		}

    #if UNITY_EDITOR
    protected override void OnValidate()
		{
			//Debug.Log("UIAccordionElement_OnValidate");
			base.OnValidate();
    ...
    public void OnValueChanged(bool state)
		{
			//Debug.Log("UIAccordionElement_OnValueChanged_m_LayoutElement: " + m_LayoutElement);
			//Debug.Log("UIAccordionElement_OnValueChanged_m_Accordion: " + m_Accordion);
			...
			{
				//Debug.Log("UIAccordionElement_OnValueChanged_transition: " + transition);
				if (state)
				{
					//Debug.Log("UIAccordionElement_OnValueChanged_state_true: " + state);
					this.m_LayoutElement.preferredHeight = -1f;
				}
				else
				{
					//Debug.Log("UIAccordionElement_OnValueChanged_state_false: " + state);
